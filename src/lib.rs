...
pub unsafe fn c25519_smult(mut result: *mut uint8_t, mut q: *const uint8_t, mut e: *const uint8_t) {
...
pub unsafe fn compact_wipe(mut data: *mut libc::c_void, mut length: size_t) -> *mut libc::c_void {
